/*resource "aws_autoscaling_policy" "eks_asp_cpu_up" {
...
resource "aws_cloudwatch_metric_alarm" "eks_cwm_cpu_up" {
    ...
    alarm_actions = [ aws_autoscaling_policy.eks_asp_cpu_up.arn ]
  
}

resource "aws_autoscaling_policy" "eks_asp_cpu_down" {
...
resource "aws_cloudwatch_metric_alarm" "eks_cwm_cpu_down" {
    ...
    alarm_actions = [ aws_autoscaling_policy.eks_asp_cpu_down.arn ]
